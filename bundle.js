...
var _gameChart = require("./scripts/game-chart");
...
},{"./chunks/helpers.segment.cjs":4,"@kurkle/color":2}],4:[function(require,module,exports){
/*!
 * Chart.js v4.4.3
 * https://www.chartjs.org
 * (c) 2024 Chart.js Contributors
...
},{"@kurkle/color":2}],5:[function(require,module,exports){
"use strict";
...
function clear_all() {
  ...
  held_letters.map(function (letters, index) {
    (0, _qol.remove)(holds[index], letters);
    (0, _qol.remove)(holds[index], replace_icon_list[index]);
  });
  loaded_letters.map(function (letters, index) {
    (0, _qol.remove)(slots[index], letters);
    (0, _qol.remove)(slots[index], hook_icon);
  });
  held_letters = [];
  loaded_letters = [];
